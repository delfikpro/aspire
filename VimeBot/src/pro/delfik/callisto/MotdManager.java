...
public class MotdManager {
    ...
    public static void update() {
        ...
        if (dayStartLevel == -1 || dayStartMoney == -1)
            newDay(true);
        ...
        if (dayStartedAt == null)
            VimeBot.queue("/g motd edit 11 &f");
        else
            VimeBot.queue("/g motd edit 11 &c&lInfo is provided at " + dayStartedAt);
    ...
    public static void newDay(boolean improperly) {
        ...
        if (improperly)
            dayStartedAt = new SimpleDateFormat("HH:mm").format(new Date());
        else {
